...
class DataTransformation:
    ...
    def initiate_data_transformation(self,train_path,test_path):
        try:
            ...
            logging.info(f'Applying preproccesing object on training dateframe and testing dataframe.')
            ...
            save_object(
                file_path=self.data_trasformation_config.preprocessor_obj_path,
            ...
            return (
                train_arr,
                test_arr,
                self.data_trasformation_config.preprocessor_obj_path
            )
        except Exception as e:
            raise CustomException(e,sys)